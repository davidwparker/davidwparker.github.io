...
Drag the following bookmarklet to you bookmarks and use it whenever you want to save metadata to any web domain you would like.  If you don't like the idea of running a script off someone else's server, then feel free to download it via "github":http://github.com and put it on your server.
...
The code is on "github":http://github.com.  There are some things which I would like to see changed/added:
