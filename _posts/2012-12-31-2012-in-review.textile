...
This year, I read a ton of books (see numbers below), which has been nothing short of fantastic. No, not every book is fantastic, but the ones that really stood out to me this year were "Running Lean":/2012/11/19/book-running-lean/ and "Crazy Love":/2012/10/05/book-crazy-love/. 
...
h3(header). Code (and more Learning)
...
I competed in all three "Ludum Dare":http://www.ludumdare.com competitions this year. You can find my code and entries on the game dev "link":/gamedev. Needless to say, I taught myself Three.js, Processing.js, and Cocos2d-html5 (and CocosBuilder) during these events.
...
h3(header). Travel and more Life
...
h2(header). Not Awesome Stuff

Last year, I did a Marathon and ran several races. This year, the most that I did was run with a friend for 9-10 miles of her marathon. This 
...
| Emails sent | 912 | 704 | 66 | 77 |
| Concerts | 2 | 3 | 1 | 0 |
| _Travel_ | ||||
| Roundtrip Flights to Montgomery | 1 | 1 | 2 | 1 |
| Roundtrip Flights elsewhere | 4 | 0 | 0 | 0 |
| _Career_ | ||||
| Networking Events | 37 | 28 | 5 | 0 |
| Conferences attendend | 1 | 0 | 0 | 0 |
| _Tech_ | ||||
| Apps Published (total) | 1 | 1 | 0 | 0 |
| Android Apps | 1 | 1 | 0 | 0 |
| # Releases (new and old Android) | 2 | 7 | 0 | 0 |
| Games Created (total) | 3 | 1 | 0 | 0 |
| Screencasts Recorded | 4 | 19 | 0 | 0 |
